                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control datetimepicker-input" id="license_expiry_date" name="license_expiry_date" value="{{ $data->license_expiry_date }}"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="emergency_name" name="emergency_name" value="{{ $data->emergency_name }}"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Hp Kontak Darurat</label>
                                        <input type="text" class="form-control" id="emergency_phone" name="emergency_phone" value="{{ $data->emergency_phone }}"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
