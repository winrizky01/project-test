        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-default">
                    ...
                    <!-- /.card-header -->
                    <form id="form" method="POST" action="{{ url('vehincles/update').'/'.$data->id }}">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="plate_number" name="plate_number" value="{{ $data->plate_number }}"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
